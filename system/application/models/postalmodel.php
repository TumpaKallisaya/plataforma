...
class postalModel extends Model {
    function get_all_persona_usuario($cod_usuario) {
       // $this->postalmodel = $this->load->database('siscor', true);
    ...
    function InputSelect($LaKeySelection,$LosElementos,$Id){//echo $compB;
...
///////////////////////////////(((((((((((((((((((((((((((((((((((
	...
	function InputSelect3($LaKeySelection,$LosElementos,$Id,$TipoC,$Tipo,$TipoA,$TipoB){
		$this->db->where($TipoC,$Tipo);
		$this->db->where($TipoA,$TipoB);
	    $this->db->order_by($Id,'asc');
	    $query = $this->db->get($LaKeySelection);
	    $data = array();
	    //$data[]='Seleccione un elemento'; //aqui agregamos una opcion sin valor a nuestro select, la cual sera la seleccion por defecto
