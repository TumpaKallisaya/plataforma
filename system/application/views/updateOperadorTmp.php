            ...
            <div class="content-widgets gray">
              ...
              <?php if($flag==1){?>
                            <div class="alert alert-success">
                                        ...
                                        Los cambios se realizarán previa revisión del administrador asignado, serán confirmados por correo electrónico.
                                        </div>
              <?php }?>
                <table>
                <tr>
                ...
                <tr>
                                ...
                                <td><input type="textarea" name="comentarios_solicitud" id="grumble" value=" "/></td>
                </tr>           
                <tr>
                <td colspan="2"><input type="file" name="archivo" class="file_1" accept=".pdf" /></td>
                <td>
                </td>
                <td>                               
